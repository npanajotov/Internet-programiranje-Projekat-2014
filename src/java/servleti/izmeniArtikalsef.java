...
@WebServlet(name = "izmeniArtikalsef", urlPatterns = {"/izmeniArtikalsef"})
public class izmeniArtikalsef extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (status.equals("Otpisano")) {
                ...
                iskaz.executeUpdate("UPDATE artikal SET naziv='" + naziv + "', status='" + status + "' WHERE id='" + id + "'");
                String izmArtikal = "";
                ...
                RequestDispatcher rd = request.getRequestDispatcher("artikli-sef.jsp");
                rd.forward(request, response);
            }
