...
@WebServlet(name = "ZatraziArtikal", urlPatterns = {"/ZatraziArtikal"})
public class ZatraziArtikal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (naziv.equals("") && model.equals("") && kolicina == 0) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("zatraziArtikal.jsp");
                rd.forward(request, response);
            }
