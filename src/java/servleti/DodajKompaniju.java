...
@WebServlet(name = "DodajKompaniju", urlPatterns = {"/DodajKompaniju"})
public class DodajKompaniju extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (naziv.equals("") && pib == 0) {
                ...
                iskaz.executeUpdate("INSERT INTO kompanija(naziv,adresa,telefon,mejl,pib,kontaktosoba) " + "VALUES('" + naziv + "','" + adresa + "','" + telefon + "','" + mejl + "','" + pib + "','" + kosoba + "')");
                String dlUspeh = "";
                dlUspeh = "<div class=\"infoPop obavestenje\"><h5>Uspesno ste dodali kompaniju!</h5></div>";
