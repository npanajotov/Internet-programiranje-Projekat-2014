        ...
        <div id="center">
            <div class="eight columns">
                <div class="formContent">
                    <form name="izmeniArt" class="myForm" method="post" action="izmeniArtikalsef">
                        <%
                        ...
                        <input type="hidden" name="id" value="<%=rezultatz.getString("id")%>" class="full-width" />
                         <p>Naziv artikla:</p>
                        <input type="text" name="naziv" value="<%=rezultatz.getString("naziv")%>" class="full-width" readonly />
                        Status:
